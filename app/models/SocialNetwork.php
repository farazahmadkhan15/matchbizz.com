...
class SocialNetwork extends BaseModel
{
     ...
     *
     * @var string
     * @Column(column="baseUrl", type="string", length=100, nullable=false)
     */
    protected $baseUrl;
    ...
    /**
     * Method to set the value of field baseUrl
     *
    ...
    public function initialize()
    {
        ...
        $this->setSource("socialNetwork");
        $this->hasMany('id', 'Socialnetworkaccount', 'socialNetworkId', ['alias' => 'Socialnetworkaccount']);
    }
